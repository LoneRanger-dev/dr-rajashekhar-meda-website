...
function Card({
  ...
  size?: "default" | "sm"
  /** `glass` = floating frosted card that lifts + glows on hover. */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "glass"
          ? "glass lift border-0"
          : "rounded-xl bg-card ring-1 ring-foreground/10 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        className
      )}
      {...props}
    />
