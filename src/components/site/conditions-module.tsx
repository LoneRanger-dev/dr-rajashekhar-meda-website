      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal className="text-center space-y-4 max-w-3xl mx-auto mb-10 sm:mb-12" blur={false} y={16}>
          ...
          <p className="type-lead text-muted-foreground">
            Explore comprehensive patient education guides for laparoscopic keyhole surgeries, laser surgery, vascular procedures, and 24/7 emergency surgical care by Dr. Rajashekhar Meda at Suraksha Hospital.
          </p>
        </Reveal>
